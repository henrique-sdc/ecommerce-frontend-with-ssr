...
const DropdownMenuItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & {
    inset?: boolean
    variant? : "default" | "destructive" // Fazendo a tipagem do variant
  }
>(({ className, inset, variant, ...props }, ref) => ( // Adicionando o variant
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      dropdownMenuItemVariants({variant, className}), // Falando que o variant é uma propriedade
      inset && "pl-8",
    )}
    {...props}
  />
